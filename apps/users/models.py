...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(max_length=10, verbose_name="用户性别", null=True, blank=True,
                              choices=(("girl", "女"), ("boy", "男")), default="girl")
    address = models.CharField(max_length=200, verbose_name="用户地址", null=True, blank=True)
    phone = models.CharField(max_length=11, verbose_name="用户手机号码", null=True, blank=True)
...
class EmailVerifyCode(models.Model):
    ...
    send_type = models.CharField(max_length=200, verbose_name="验证方式",
                                 choices=(("register", "注册"), ("forget", "找回密码"), ("change", "更换邮箱地址")))
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
